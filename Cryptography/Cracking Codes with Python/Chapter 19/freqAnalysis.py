...
def main():
    ...
    print("getFrequencyOrder = ", getFrequencyOrder(myMessage))
    print()
...
def getFrequencyOrder(message):
    ...
    print("letterToFreq = ",letterToFreq)
    ...
    print("freqToLetter = ",freqToLetter)
