...
def main():
    ...
    message = "KVZIEBCEN CKYIECDVG DBCOOVK HN CKYCFEUFJ ECHIKUCF MIBEVG FHOHFD NQXVWXIV NWQFWQG HG IHF FH EQF AB EWHB XI GAEEXD"
    ...
    #      key - 26 letters representing cipher letters
    #      value - 1 or more letters representing possible plaintext values for key letter
    #      when just one value exists, we've found that letter mapping
...
def hackSimpleSub(message):
    ...
    # intersectedMap is a dictionary
